...
% Path cost
in.oc.cost.path     = {'bdcontrol^2 + epsilon_c^2/cos(pi*x/(2*xmax))','m^2/s^4'}; 
...
% Constants
in.const.epsilon_c = {0.1,'m^2/s^4'};
in.const.xmax      = {0.125,'m'};
in.const.tol       = {1e-4,'nd'}; 
in.const.NMax      = {1e11,'nd'}; 
...
in.CONT{ind}.const.epsilon = linspace(0,-0.0995,in.CONT{ind}.numCases);
