...
in.traj.x2 = 1; % Initial Velocity 
in.traj.x3 = 0;
in.traj.t = 0;
in.ID.timeIntegrate = 1; 
...
numNuTotal = 5; % For free radial magnitude
...
guessX(numStates+1,1) = 0.01; 
guessX(numStates+2,1) = 0.01; 
guessX(numStates+3,1) = 0.01;
guessX(numStates+4,1) = 0.01;
