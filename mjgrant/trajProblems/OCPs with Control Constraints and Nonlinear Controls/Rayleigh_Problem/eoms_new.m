...
u1 = -1;
ham1 = y(4)*y(2) + y(5)*(-y(1) + y(2)*(1.4 - 0.14*y(2)^2) + 4*u1) + y(6) + u1^2 + y(1)^2;

u2 = 1;
ham2 = y(4)*y(2) + y(5)*(-y(1) + y(2)*(1.4 - 0.14*y(2)^2) + 4*u2) + y(6) + u2^2 + y(1)^2;
...
u3 = -2*y(5);
ham3 = y(4)*y(2) + y(5)*(-y(1) + y(2)*(1.4 - 0.14*y(2)^2) + 4*u3) + y(6) + u3^2 + y(1)^2;
...
dydx(3,1) = 1;
dydx(4,1) = -2*y(1) + y(5);
dydx(5,1) = -y(4) - 1.4*y(5) + 0.28*y(2)*y(5);
dydx(6,1) = 0;
