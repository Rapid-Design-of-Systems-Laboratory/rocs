...
sol = bvpsolver(@eoms_new,@bcs_new,solinit,bvpOptions);
toc
...
for count = 1:1:length(sol.x)
    ...
    ham1 = x1(1,count)*x2(1,count) + lam_x2(1,count)*(-x1(1,count) + x2(1,count)*(1.4 - 0.14*x2(1,count)^2) + 4*u1) + lam_t(1,count) + u1^2 + x1(1,count)^2;
    ham2 = x1(1,count)*x2(1,count) + lam_x2(1,count)*(-x1(1,count) + x2(1,count)*(1.4 - 0.14*x2(1,count)^2) + 4*u2) + lam_t(1,count) + u2^2 + x1(1,count)^2;
    ...
    u3 = (-2*lam_x2(1,count));
    ham3 = x1(1,count)*x2(1,count) + lam_x2(1,count)*(-x1(1,count) + x2(1,count)*(1.4 - 0.14*x2(1,count)^2) + 4*u3) + lam_t(1,count) + u3^2 + x1(1,count)^2;
