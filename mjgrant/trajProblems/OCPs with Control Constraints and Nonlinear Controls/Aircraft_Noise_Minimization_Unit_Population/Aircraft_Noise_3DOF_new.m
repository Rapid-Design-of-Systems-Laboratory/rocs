...
in.bvpOptions = bvpset('AbsTol',1e-9,'RelTol',1e-10,'Nmax',10000000000000000,'Stats','on');
...
in.const.mass  = {7180/9.80665,'kg'}; % 7180
...
in.oc.guess.timeIntegrate = 40; %40; 40 runs with 1e5 as costate guess, 1e-8 abs and rel tol
