function [child] = inversionMutation(par,bounds,genInfo,Ops)
% Inversion mutation  inverts the bits or permutation between two
% cut points.
%
% function [newSol] = inversionMutation(parent,bounds,Ops)
...
if pos1 ~= pos2
   ...
   child = [par(1:pos1-1) fliplr(par(pos1:pos2)) par(pos2+1:(sz+1))];
else
   child = par;
end
