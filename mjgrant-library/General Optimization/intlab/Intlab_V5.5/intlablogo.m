...
function addtext(screensaver)
  if screensaver
    ...
    text(-.3,-5.2,'The Matlab toolbox for Reliable Computing  -  www.ti3.tu-harburg.de/rump', ...
      'Fontsize',8, ...
      'FontName','Sans Serif', ...
      'HorizontalAlignment','left');
    text(-.25,-6.2,'Siegfried M. Rump, Institute for Reliable Computing, Hamburg University of Technology  ', ...
      'Fontsize',8, ...
      'FontName','Sans Serif', ...
      'HorizontalAlignment','left');
  else
    ...
    text(-.3,-5.2,'The Matlab toolbox for Reliable Computing  -  www.ti3.tu-harburg.de/rump', ...
      ...
      'FontName','Sans Serif', ...
      'HorizontalAlignment','left');
    text(-.19,-6.2,'Siegfried M. Rump, Institute for Reliable Computing, Hamburg University of Technology  ', ...
      'Fontsize',10, ...
      'FontName','Sans Serif', ...
      'HorizontalAlignment','left');
  end
