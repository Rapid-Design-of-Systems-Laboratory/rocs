...
cada1td1 = zeros(size(cada1f1dV,1),3);
cada1td1(:,Gator1Data.Index11) = cada1tf1.*cada1f1dV;
cada1td1(:,2) = cada1td1(:,2) + cada1f1.*cada1f2dV;
ydot.dV = cada1td1;
...
cada1td1 = zeros(size(cada1f3dV,1),3);
cada1td1(:,Gator1Data.Index15) = cada1tf1.*cada1f3dV;
...
cada1td1 = zeros(size(cada1f5dV,1),5);
cada1td1(:,Gator1Data.Index17) = cada1f5dV./cada1tf1;
cada1tf1 = cada1f5(:,Gator1Data.Index18);
cada1tf2 = cada1f7(:,Gator1Data.Index19);
cada1td1(:,Gator1Data.Index20) = cada1td1(:,Gator1Data.Index20) + -cada1tf1./cada1tf2.^2.*cada1f7dV;
psidot.dV = cada1td1;
...
cada1td1 = zeros(size(cada1f3dV,1),3);
cada1td1(:,Gator1Data.Index22) = cada1tf1.*cada1f3dV;
cada1td1(:,1) = cada1td1(:,1) + cada1f3.*cada1f4dV;
cada1f5dV = cada1td1;
cada1f5 = cada1f3.*cada1f4;
...
cada1td1(:,Gator1Data.Index25) = cada1f8dV./cada1tf1;
