...
cada2td1 = zeros(size(cada1f4dV,1),2);
cada2td1(:,1) = cada1f3dV.*cada1f4dV;
cada2td1(:,2) = cada2td1(:,2) + cada1f4.*cada1f3dVdV;
cada2f1dV = cada2td1;
cada2f1 = cada1f4.*cada1f3dV;
cada1td1dV = cada2f1dV;
cada1td1(:,2) = cada2f1;
cada2f1 = cada1td1(:,1);
cada2td1 = zeros(size(cada1f3dV,1),2);
cada2td1(:,2) = cada1f4dV.*cada1f3dV;
...
cada1f8 = v.f.*cada1f7;
cada1tf1dV = cada1f8dV(:,Gator2Data.Index5);
cada1tf1 = cada1f8(:,Gator1Data.Index1);
cada2f1 = size(cada1f5dV,1);
cada1td1 = zeros(cada2f1,4);
cada2tf1 = cada1tf1(:,Gator2Data.Index6);
cada2td1 = zeros(size(cada1f5dVdV,1),8);
cada2td1(:,Gator2Data.Index7) = cada1f5dVdV./cada2tf1;
cada2tf1 = cada1f5dV(:,Gator2Data.Index8);
cada2tf2 = cada1tf1(:,Gator2Data.Index9);
cada2td1(:,Gator2Data.Index10) = cada2td1(:,Gator2Data.Index10) + -cada2tf1./cada2tf2.^2.*cada1tf1dV;
cada2f1dV = cada2td1;
cada2f1 = cada1f5dV./cada1tf1;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index2) = cada2f1;
cada1tf1dV = cada1f5dV(:,Gator2Data.Index11);
cada1tf1 = cada1f5(:,Gator1Data.Index3);
cada1tf2dV = cada1f8dV(:,Gator2Data.Index12);
cada1tf2 = cada1f8(:,Gator1Data.Index4);
cada2f1 = cada1td1(:,Gator1Data.Index5);
cada2f2dV = -cada1tf1dV;
cada2f2 = uminus(cada1tf1);
cada2tf2 = cada1tf2(:,Gator2Data.Index13);
cada2f3dV = 2.*cada2tf2.^(2-1).*cada1tf2dV;
cada2f3 = cada1tf2.^2;
cada2tf1 = cada2f3(:,Gator2Data.Index14);
cada2td1 = zeros(size(cada2f2dV,1),8);
cada2td1(:,Gator2Data.Index15) = cada2f2dV./cada2tf1;
cada2tf1 = cada2f2(:,Gator2Data.Index16);
cada2tf2 = cada2f3(:,Gator2Data.Index17);
cada2td1(:,Gator2Data.Index18) = cada2td1(:,Gator2Data.Index18) + -cada2tf1./cada2tf2.^2.*cada2f3dV;
cada2f4dV = cada2td1;
cada2f4 = cada2f2./cada2f3;
cada2tf1 = cada1f8dV(:,Gator2Data.Index19);
cada2td1 = cada2tf1.*cada2f4dV;
cada2tf1 = cada2f4(:,Gator2Data.Index20);
cada2td1(:,Gator2Data.Index21) = cada2td1(:,Gator2Data.Index21) + cada2tf1.*cada1f8dVdV;
cada2f5dV = cada2td1;
...
cada1td1dV = cada2td1;
cada1td1(:,Gator1Data.Index5) = cada2f6;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index25) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada1f2 = cos(psi.f);
cada1tf1dV = cada1f2dV(:,Gator2Data.Index26);
...
cada2f1 = cada1td1(:,2);
cada2tf1 = cada1f2dV(:,Gator2Data.Index30);
cada2td1 = zeros(size(cada1f1dV,1),3);
cada2td1(:,Gator2Data.Index31) = cada2tf1.*cada1f1dV;
...
cada2td1(:,Gator2Data.Index33) = cada1td1dV(:,Gator2Data.Index34);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index35) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
cada1f1dVdV = cada1td1dV; cada1f1dV = cada1td1;
...
cada1td1 = zeros(cada2f1,3);
cada2td1 = zeros(size(cada1tf1dV,1),5);
cada2td1(:,Gator2Data.Index37) = cada1f1dV.*cada1tf1dV;
cada2tf1 = cada1tf1(:,Gator2Data.Index38);
cada2td1(:,Gator2Data.Index39) = cada2td1(:,Gator2Data.Index39) + cada2tf1.*cada1f1dVdV;
cada2f1dV = cada2td1;
cada2f1 = cada1tf1.*cada1f1dV;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index9) = cada2f1;
cada2f1 = cada1td1(:,2);
cada2tf1 = cada1f2dV(:,Gator2Data.Index40);
cada2td1 = zeros(size(cada1f1dV,1),3);
cada2td1(:,Gator2Data.Index41) = cada2tf1.*cada1f1dV;
cada2td1(:,2) = cada2td1(:,2) + cada1f1.*cada1f2dVdV;
cada2f2dV = cada2td1;
cada2f2 = cada1f1.*cada1f2dV;
cada2f3dV = cada2f2dV;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),8);
cada2td1(:,Gator2Data.Index42) = cada2f3dV;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index45) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index46) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,1) = cada2f3;
...
cada1f4 = sin(bank.f);
cada1tf1dV = cada1f4dV(:,Gator2Data.Index52);
cada1tf1 = cada1f4(:,Gator1Data.Index12);
cada2f1 = size(cada1f3dV,1);
cada1td1 = zeros(cada2f1,3);
cada2td1 = zeros(size(cada1tf1dV,1),5);
cada2td1(:,Gator2Data.Index53) = cada1f3dV.*cada1tf1dV;
cada2tf1 = cada1tf1(:,Gator2Data.Index54);
cada2td1(:,Gator2Data.Index55) = cada2td1(:,Gator2Data.Index55) + cada2tf1.*cada1f3dVdV;
cada2f1dV = cada2td1;
cada2f1 = cada1tf1.*cada1f3dV;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index13) = cada2f1;
cada2f1 = cada1td1(:,1);
cada2tf1 = cada1f4dV(:,Gator2Data.Index56);
cada2td1 = zeros(size(cada1f3dV,1),3);
cada2td1(:,Gator2Data.Index57) = cada2tf1.*cada1f3dV;
cada2td1(:,1) = cada2td1(:,1) + cada1f3.*cada1f4dVdV;
cada2f2dV = cada2td1;
cada2f2 = cada1f3.*cada1f4dV;
cada2f3dV = cada2f2dV;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),8);
cada2td1(:,Gator2Data.Index58) = cada2f3dV;
...
cada1tf1dV = cada1f7dV(:,Gator2Data.Index62);
...
cada2td1(:,Gator2Data.Index64) = cada1f5dVdV./cada2tf1;
cada2tf1 = cada1f5dV(:,Gator2Data.Index65);
cada2tf2 = cada1tf1(:,Gator2Data.Index66);
cada2td1(:,Gator2Data.Index67) = cada2td1(:,Gator2Data.Index67) + -cada2tf1./cada2tf2.^2.*cada1tf1dV;
cada2f1dV = cada2td1;
cada2f1 = cada1f5dV./cada1tf1;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index15) = cada2f1;
cada1tf1dV = cada1f5dV(:,Gator2Data.Index68);
cada1tf1 = cada1f5(:,Gator1Data.Index16);
cada1tf2dV = cada1f7dV(:,Gator2Data.Index69);
cada1tf2 = cada1f7(:,Gator1Data.Index17);
cada2f1 = cada1td1(:,Gator1Data.Index18);
cada2f2dV = -cada1tf1dV;
cada2f2 = uminus(cada1tf1);
cada2tf2 = cada1tf2(:,Gator2Data.Index70);
cada2f3dV = 2.*cada2tf2.^(2-1).*cada1tf2dV;
cada2f3 = cada1tf2.^2;
cada2tf1 = cada2f3(:,Gator2Data.Index71);
cada2td1 = zeros(size(cada2f2dV,1),10);
cada2td1(:,Gator2Data.Index72) = cada2f2dV./cada2tf1;
cada2tf1 = cada2f2(:,Gator2Data.Index73);
cada2tf2 = cada2f3(:,Gator2Data.Index74);
cada2td1(:,Gator2Data.Index75) = cada2td1(:,Gator2Data.Index75) + -cada2tf1./cada2tf2.^2.*cada2f3dV;
cada2f4dV = cada2td1;
cada2f4 = cada2f2./cada2f3;
cada2tf1 = cada1f7dV(:,Gator2Data.Index76);
cada2td1 = cada2tf1.*cada2f4dV;
cada2tf1 = cada2f4(:,Gator2Data.Index77);
cada2td1(:,Gator2Data.Index78) = cada2td1(:,Gator2Data.Index78) + cada2tf1.*cada1f7dVdV;
cada2f5dV = cada2td1;
cada2f5 = cada2f4.*cada1f7dV;
cada2f6dV = cada2f5dV;
cada2f6 = cada2f1 + cada2f5;
cada2td1 = zeros(size(cada1td1,1),24);
cada2td1(:,Gator2Data.Index79) = cada2f6dV;
cada2td1(:,Gator2Data.Index80) = cada1td1dV(:,Gator2Data.Index81);
cada1td1dV = cada2td1;
cada1td1(:,Gator1Data.Index18) = cada2f6;
...
cada1f4 = cos(bank.f);
cada1tf1dV = cada1f4dV(:,Gator2Data.Index83);
cada1tf1 = cada1f4(:,Gator1Data.Index19);
cada2f1 = size(cada1f3dV,1);
cada1td1 = zeros(cada2f1,3);
cada2td1 = zeros(size(cada1tf1dV,1),5);
cada2td1(:,Gator2Data.Index84) = cada1f3dV.*cada1tf1dV;
cada2tf1 = cada1tf1(:,Gator2Data.Index85);
cada2td1(:,Gator2Data.Index86) = cada2td1(:,Gator2Data.Index86) + cada2tf1.*cada1f3dVdV;
cada2f1dV = cada2td1;
cada2f1 = cada1tf1.*cada1f3dV;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index20) = cada2f1;
cada2f1 = cada1td1(:,1);
cada2tf1 = cada1f4dV(:,Gator2Data.Index87);
cada2td1 = zeros(size(cada1f3dV,1),3);
cada2td1(:,Gator2Data.Index88) = cada2tf1.*cada1f3dV;
cada2td1(:,1) = cada2td1(:,1) + cada1f3.*cada1f4dVdV;
cada2f2dV = cada2td1;
cada2f2 = cada1f3.*cada1f4dV;
cada2f3dV = cada2f2dV;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),8);
cada2td1(:,Gator2Data.Index89) = cada2f3dV;
...
cada2td1(:,1) = cada2f3dV;
cada2td1(:,Gator2Data.Index92) = cada1td1dV(:,Gator2Data.Index93);
cada1td1dV = cada2td1;
cada1td1(:,1) = cada2f3;
cada1f8dVdV = cada1td1dV; cada1f8dV = cada1td1;
cada1f8 = cada1f6 - cada1f7;
cada1tf1dV = v.dV(:,Gator2Data.Index94);
cada1tf1 = v.f(:,Gator1Data.Index22);
cada2f1 = size(cada1f8dV,1);
cada1td1 = zeros(cada2f1,5);
cada2tf1 = cada1tf1(:,Gator2Data.Index95);
cada2td1 = zeros(size(cada1f8dVdV,1),13);
cada2td1(:,Gator2Data.Index96) = cada1f8dVdV./cada2tf1;
cada2td1(:,Gator2Data.Index97) = cada2td1(:,Gator2Data.Index97) + -cada1f8dV./cada1tf1.^2.*cada1tf1dV;
cada2f1dV = cada2td1;
cada2f1 = cada1f8dV./cada1tf1;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index23) = cada2f1;
cada2f1 = cada1td1(:,1);
cada2f2dV = -cada1f8dV;
cada2f2 = uminus(cada1f8);
cada2f3dV = 2.*v.f.^(2-1).*v.dV;
cada2f3 = v.f.^2;
cada2tf1 = cada2f3(:,Gator2Data.Index98);
cada2td1 = zeros(size(cada2f2dV,1),5);
cada2td1(:,Gator2Data.Index99) = cada2f2dV./cada2tf1;
cada2td1(:,1) = cada2td1(:,1) + -cada2f2./cada2f3.^2.*cada2f3dV;
cada2f4dV = cada2td1;
cada2f4 = cada2f2./cada2f3;
cada2tf1 = v.dV(:,Gator2Data.Index100);
cada2f5dV = cada2tf1.*cada2f4dV;
cada2f5 = cada2f4.*v.dV;
cada2f6dV = cada2f5dV;
cada2f6 = cada2f1 + cada2f5;
cada2td1 = zeros(size(cada1td1,1),18);
cada2td1(:,Gator2Data.Index101) = cada2f6dV;
...
cada2td1 = zeros(size(cada1td1,1),16);
cada2td1(:,Gator2Data.Index104) = ydot.dVdV;
cada2td1(:,Gator2Data.Index105) = cada1td1dV(:,Gator2Data.Index106);
cada1td1dV = cada2td1;
cada1td1(:,Gator1Data.Index25) = ydot.dV;
cada2td1 = zeros(size(cada1td1,1),19);
cada2td1(:,Gator2Data.Index107) = zdot.dVdV;
cada2td1(:,Gator2Data.Index108) = cada1td1dV(:,Gator2Data.Index109);
cada1td1dV = cada2td1;
cada1td1(:,Gator1Data.Index26) = zdot.dV;
cada2td1 = zeros(size(cada1td1,1),24);
cada2td1(:,Gator2Data.Index110) = vdot.dVdV;
...
cada2td1(:,Gator2Data.Index113) = psidot.dVdV;
...
cada2td1(:,Gator2Data.Index116) = gamdot.dVdV;
...
output.dynamics.dVdV_location = [output.dynamics.dV_location(Gator2Data.Index119,:), Gator2Data.Index120];
output.integrand.dVdV_size = [output.integrand.dV_size,10];
output.integrand.dVdV_location = [output.integrand.dV_location(Gator2Data.Index121,:), Gator2Data.Index122];
end
