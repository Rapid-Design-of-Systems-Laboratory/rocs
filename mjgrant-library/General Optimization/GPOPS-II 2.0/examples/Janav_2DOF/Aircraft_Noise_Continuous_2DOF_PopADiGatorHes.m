...
function output = Aircraft_Noise_Continuous_2DOF_PopADiGatorHes(input)
global ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes
if isempty(ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes); ADiGator_LoadData(); end
Gator1Data = ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes.Aircraft_Noise_Continuous_2DOF_PopADiGatorHes.Gator1Data;
Gator2Data = ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes.Aircraft_Noise_Continuous_2DOF_PopADiGatorHes.Gator2Data;
...
cada1f4 = cos(gam.f);
cada1tf1dV = cada1f4dV(:,Gator2Data.Index2);
cada1tf1 = cada1f4(:,Gator1Data.Index1);
cada2f1 = size(cada1f3dV,1);
cada1td1 = zeros(cada2f1,3);
cada2td1 = zeros(size(cada1tf1dV,1),5);
cada2td1(:,Gator2Data.Index3) = cada1f3dV.*cada1tf1dV;
cada2tf1 = cada1tf1(:,Gator2Data.Index4);
cada2td1(:,Gator2Data.Index5) = cada2td1(:,Gator2Data.Index5) + cada2tf1.*cada1f3dVdV;
cada2f1dV = cada2td1;
cada2f1 = cada1tf1.*cada1f3dV;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index2) = cada2f1;
cada2f1 = cada1td1(:,2);
cada2tf1 = cada1f4dV(:,Gator2Data.Index6);
cada2td1 = zeros(size(cada1f3dV,1),3);
cada2td1(:,Gator2Data.Index7) = cada2tf1.*cada1f3dV;
...
cada2td1(:,Gator2Data.Index8) = cada2f3dV;
cada2td1(:,Gator2Data.Index9) = cada1td1dV(:,Gator2Data.Index10);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada1f8 = v.f.*cada1f7;
cada1tf1dV = cada1f8dV(:,Gator2Data.Index12);
...
cada2td1(:,Gator2Data.Index14) = cada1f5dVdV./cada2tf1;
cada2tf1 = cada1f5dV(:,Gator2Data.Index15);
cada2tf2 = cada1tf1(:,Gator2Data.Index16);
cada2td1(:,Gator2Data.Index17) = cada2td1(:,Gator2Data.Index17) + -cada2tf1./cada2tf2.^2.*cada1tf1dV;
cada2f1dV = cada2td1;
cada2f1 = cada1f5dV./cada1tf1;
cada1td1dV = cada2f1dV;
cada1td1(:,Gator1Data.Index4) = cada2f1;
cada1tf1dV = cada1f5dV(:,Gator2Data.Index18);
cada1tf1 = cada1f5(:,Gator1Data.Index5);
cada1tf2dV = cada1f8dV(:,Gator2Data.Index19);
...
cada2tf2 = cada2f3(:,Gator2Data.Index24);
cada2td1(:,Gator2Data.Index25) = cada2td1(:,Gator2Data.Index25) + -cada2tf1./cada2tf2.^2.*cada2f3dV;
cada2f4dV = cada2td1;
cada2f4 = cada2f2./cada2f3;
cada2tf1 = cada1f8dV(:,Gator2Data.Index26);
cada2td1 = cada2tf1.*cada2f4dV;
cada2tf1 = cada2f4(:,Gator2Data.Index27);
cada2td1(:,Gator2Data.Index28) = cada2td1(:,Gator2Data.Index28) + cada2tf1.*cada1f8dVdV;
cada2f5dV = cada2td1;
cada2f5 = cada2f4.*cada1f8dV;
cada2f6dV = cada2f5dV;
cada2f6 = cada2f1 + cada2f5;
cada2td1 = zeros(size(cada1td1,1),24);
cada2td1(:,Gator2Data.Index29) = cada2f6dV;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index33) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada2td1(:,Gator2Data.Index37) = cada1td1dV(:,Gator2Data.Index38);
cada1td1dV = cada2td1;
cada1td1(:,2) = cada2f3;
...
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(size(cada1td1,1),3);
cada2td1(:,Gator2Data.Index39) = cada2f3dV;
cada2td1(:,2) = cada1td1dV(:,1);
cada1td1dV = cada2td1;
cada1td1(:,1) = cada2f3;
cada1f2dVdV = cada1td1dV; cada1f2dV = cada1td1;
...
cada2td1 = zeros(size(cada1td1,1),4);
cada2td1(:,1) = cada2f3dV;
cada2td1(:,Gator2Data.Index40) = cada1td1dV(:,Gator2Data.Index41);
cada1td1dV = cada2td1;
cada1td1(:,1) = cada2f3;
cada1f6dVdV = cada1td1dV; cada1f6dV = cada1td1;
cada1f6 = cada1f4 - cada1f5;
cada1tf1dV = v.dV(:,Gator2Data.Index42);
cada1tf1 = v.f(:,Gator1Data.Index11);
cada2f1 = size(cada1f6dV,1);
cada1td1 = zeros(cada2f1,4);
cada2tf1 = cada1tf1(:,Gator2Data.Index43);
cada2td1 = zeros(size(cada1f6dVdV,1),7);
cada2td1(:,Gator2Data.Index44) = cada1f6dVdV./cada2tf1;
cada2td1(:,Gator2Data.Index45) = cada2td1(:,Gator2Data.Index45) + -cada1f6dV./cada1tf1.^2.*cada1tf1dV;
cada2f1dV = cada2td1;
cada2f1 = cada1f6dV./cada1tf1;
cada1td1dV = cada2f1dV;
...
cada2f3 = v.f.^2;
cada2tf1 = cada2f3(:,Gator2Data.Index46);
cada2td1 = zeros(size(cada2f2dV,1),4);
cada2td1(:,Gator2Data.Index47) = cada2f2dV./cada2tf1;
cada2td1(:,1) = cada2td1(:,1) + -cada2f2./cada2f3.^2.*cada2f3dV;
cada2f4dV = cada2td1;
cada2f4 = cada2f2./cada2f3;
cada2tf1 = v.dV(:,Gator2Data.Index48);
cada2f5dV = cada2tf1.*cada2f4dV;
cada2f5 = cada2f4.*v.dV;
cada2f6dV = cada2f5dV;
cada2f6 = cada2f1 + cada2f5;
cada2td1 = zeros(size(cada1td1,1),11);
cada2td1(:,Gator2Data.Index49) = cada2f6dV;
cada2td1(:,Gator2Data.Index50) = cada1td1dV(:,Gator2Data.Index51);
cada1td1dV = cada2td1;
cada1td1(:,1) = cada2f6;
...
cada2td1(:,Gator2Data.Index58) = gamdot.dVdV;
...
output.dynamics.dVdV_size = [output.dynamics.dV_size,7];
output.dynamics.dVdV_location = [output.dynamics.dV_location(Gator2Data.Index61,:), Gator2Data.Index62];
output.integrand.dVdV_size = [output.integrand.dV_size,7];
output.integrand.dVdV_location = [output.integrand.dV_location(Gator2Data.Index63,:), Gator2Data.Index64];
end


function ADiGator_LoadData()
global ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes
ADiGator_Aircraft_Noise_Continuous_2DOF_PopADiGatorHes = load('Aircraft_Noise_Continuous_2DOF_PopADiGatorHes.mat');
return
end