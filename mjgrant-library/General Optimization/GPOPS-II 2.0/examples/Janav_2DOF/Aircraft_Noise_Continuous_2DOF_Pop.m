function output = Aircraft_Noise_Continuous_2DOF_Pop(input)
%----------------------------------------%
...
gamdot   = ((T.*sin(aoa)+L)./mass-cgam.*gravity)./v;
output.dynamics  = [xdot, zdot ,vdot, gamdot];
