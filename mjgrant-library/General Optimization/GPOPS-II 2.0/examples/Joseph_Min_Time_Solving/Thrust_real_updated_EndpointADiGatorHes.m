...
function output = Thrust_real_updated_EndpointADiGatorHes(input)
global ADiGator_Thrust_real_updated_EndpointADiGatorHes
if isempty(ADiGator_Thrust_real_updated_EndpointADiGatorHes); ADiGator_LoadData(); end
Gator1Data = ADiGator_Thrust_real_updated_EndpointADiGatorHes.Thrust_real_updated_EndpointADiGatorHes.Gator1Data;
Gator2Data = ADiGator_Thrust_real_updated_EndpointADiGatorHes.Thrust_real_updated_EndpointADiGatorHes.Gator2Data;
...
tf.dv = input.phase.finaltime.dv;
tf.f = input.phase.finaltime.f;
%User Line: tf = input.phase.finaltime;
%User Line: % cost
output.objective.dv = tf.dv;
output.objective.f = tf.f;
...
global ADiGator_Thrust_real_updated_EndpointADiGatorHes
ADiGator_Thrust_real_updated_EndpointADiGatorHes = load('Thrust_real_updated_EndpointADiGatorHes.mat');
return
end