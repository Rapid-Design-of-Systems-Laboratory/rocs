function y = cadacreatearray(callerstr,varargin)
% Called by zeros, ones, eye, true, false, cell
%
...
if length(Inputs) == 1
  if ADIGATOR.EMPTYFLAG
    ...
    if strcmp(callerstr,'cell')
      y = cadastruct(cell(0),'dummycell',ADIGATOR.VARINFO.COUNT-1,1);
    end
    return
  end
...
if strcmp(callerstr,'cell')
  if yvec > 0
    error('cannot create cell using vectorized dimension');
  end
  yval = cell(FMrow,FNcol);
