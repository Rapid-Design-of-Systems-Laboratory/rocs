...
%
    ...
    elseif strcmp(char(variable),'ur')
           solution = {'(lamG*cos(l)*(x/mu)^(1/2) - lamF*sin(l)*(x/mu)^(1/2))/((lamG*cos(l)*(x/mu)^(1/2) - lamF*sin(l)*(x/mu)^(1/2))^2 + ((2*lamX*x*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*(f + cos(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamG*(g + sin(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2 + ((lamH*cos(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamK*sin(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};


   elseif strcmp(char(variable),'ut')
          solution = {'-((2*lamX*x*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*(f + cos(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamG*(g + sin(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))/((lamG*cos(l)*(x/mu)^(1/2) - lamF*sin(l)*(x/mu)^(1/2))^2 + ((2*lamX*x*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*(f + cos(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamG*(g + sin(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2 + ((lamH*cos(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamK*sin(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};


   elseif strcmp(char(variable),'un')
          solution = {'-((lamH*cos(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (lamL*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamK*sin(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (f*lamG*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))/((lamG*cos(l)*(x/mu)^(1/2) - lamF*sin(l)*(x/mu)^(1/2))^2 + ((2*lamX*x*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*(f + cos(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamG*(g + sin(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2 + ((lamH*cos(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamK*sin(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    
    elseif strcmp(char(variable),'del')      
           solution = {'0.5*(1+tanh(((((lamG*cos(l)*(x/mu)^(1/2) - lamF*sin(l)*(x/mu)^(1/2))^2 + ((2*lamX*x*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*(f + cos(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamG*(g + sin(l)*(f*cos(l) + g*sin(l) + 2))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2 + ((lamH*cos(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (lamL*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (lamK*sin(l)*(x/mu)^(1/2)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (f*lamG*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*(k*cos(l) - h*sin(l))*(x/mu)^(1/2))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2))/mass + lamMASS/c)/epsilonc))'};

    elseif strcmp(char(variable),'ux')
           solution = {'-lamVX/sqrt(lamVX^2 + lamVY^2 +lamVZ^2)'};
           
    elseif strcmp(char(variable),'uy')
           solution = {'-lamVY/sqrt(lamVX^2 + lamVY^2 +lamVZ^2)'};
           
    elseif strcmp(char(variable),'uz')
           solution = {'-lamVZ/sqrt(lamVX^2 + lamVY^2 +lamVZ^2)'};
           
%     elseif strcmp(char(variable),'urs')
%            solution = {'(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))/(abs((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + abs(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + abs((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};        
%     
%     elseif strcmp(char(variable),'uts')      
%            solution = {'-((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))/(abs((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + abs(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + abs((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
%     
%     elseif strcmp(char(variable),'uns')      
%            solution = {'-((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))/(abs((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + abs(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + abs((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
%     
    elseif strcmp(char(variable),'urs')
           solution = {'(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))/(abs((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + abs(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + abs((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    elseif strcmp(char(variable),'uts')
    ...
    elseif strcmp(char(variable),'uxt')  
           solution = {'-lamVXT/sqrt(lamVXT^2 + lamVYT^2 +lamVZT^2)'};
           
    elseif strcmp(char(variable),'uyt')  
           solution = {'-lamVYT/sqrt(lamVXT^2 + lamVYT^2 +lamVZT^2)'};
           
    elseif strcmp(char(variable),'uzt')  
           solution = {'-lamVZT/sqrt(lamVXT^2 + lamVYT^2 +lamVZT^2)'};
           
    elseif strcmp(char(variable),'urdhm')
           solution = {'(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};        
    
    elseif strcmp(char(variable),'utdhm')      
           solution = {'-((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    
    elseif strcmp(char(variable),'undhm')      
           solution = {'-((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    
           
    elseif strcmp(char(variable),'urpan')      
           solution = {'(lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    elseif strcmp(char(variable),'utpan')      
           solution = {'-((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
    elseif strcmp(char(variable),'unpan')      
           solution = {'-((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*(f*cos(l) + g*sin(l) + 1)) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))/(((lamH*x^(1/2)*cos(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (lamL*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (lamK*x^(1/2)*sin(l)*(h^2 + k^2 + 1))/(2*f*cos(l) + 2*g*sin(l) + 2) - (f*lamG*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1) + (g*lamF*x^(1/2)*(k*cos(l) - h*sin(l)))/(f*cos(l) + g*sin(l) + 1))^2 + (lamG*x^(1/2)*cos(l) - lamF*x^(1/2)*sin(l))^2 + ((2*lamX*x^(3/2))/(f*cos(l) + g*sin(l) + 1) + (lamF*x^(1/2)*(f + cos(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1) + (lamG*x^(1/2)*(g + sin(l)*(f*cos(l) + g*sin(l) + 2)))/(f*cos(l) + g*sin(l) + 1))^2)^(1/2)'};
...
%                     };
       elseif strcmp(char(variable),'alfamctrig')
         solution = {'pi/2',
                    '-pi/2',
                    'asin((1/(2*Cd2*alfamax))*((Cl1/(v*lamV))*(lamGAM*cos(0.5*(bankmax-bankmin)*sin(bankmctrig)+0.5*(bankmax+bankmin))+lamAZI*sin(0.5*(bankmax-bankmin)*sin(bankmctrig)+0.5*(bankmax+bankmin))/cos(gam))-Cd1))'
                   }; 
       elseif strcmp(char(variable),'bankmctrig')
         solution = {'pi/2',
                    '-pi/2',
                    'asin((atan(lamAZI/(lamGAM*cos(gam)))-0.5*(bankmax+bankmin))/(0.5*(bankmax-bankmin)))',
                    'asin((atan(lamAZI/(lamGAM*cos(gam))) + pi -0.5*(bankmax+bankmin))/(0.5*(bankmax-bankmin)))'
                   }; 
       elseif strcmp(char(variable),'alfadotmctrig')
         solution = {'atan((alfarate*lamALFAMCTRIG)/epsilon)',
                    'atan((alfarate*lamALFAMCTRIG)/epsilon) + pi'
                   };          
               
      elseif strcmp(char(variable),'alfaapprox')   
         solution = {'lamX*v/(lamY*v + lamV*g - 1)'};
         
      elseif strcmp(char(variable),'CLTrigHG')
         solution = {'pi/2',
                    '-pi/2',
                    'asin((((lamVY*((vx/(sqrt(vx^2 + (vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))^2))))-lamVX*(((vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))/(sqrt(vx^2 + (vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))^2)))))/(k*(lamVX*((vx/(sqrt(vx^2 + (vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))^2)))) + lamVY*(((vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))/(sqrt(vx^2 + (vy - (uM*(1-(((x/R)-2.5)^2))*exp(-(((x/R)-2.5)^2))))^2)))))))-c1 - c0)/(c1-c0))'
                   }; 
           elseif strcmp(char(variable),'alfatrig')   
         solution = {'pi/2',
                    '-pi/2',
                    'asin(lamGAM*Cl1/(2*Cd2*v*lamV*alfamax)-Cd1/(2*Cd2*alfamax))'
                    };
         elseif strcmp(char(variable),'uhomotopy')   
         solution = {'-lamX3/(2*(1-k1))'};
    else
